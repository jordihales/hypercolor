export default {
  ...
  head: {
    titleTemplate: titleChunk => {
      return titleChunk ? `${titleChunk} | Hypercolor` : "Gradients for Tailwind CSS | Hypercolor";
    },
    htmlAttrs: {
      lang: "en"
    },
    meta: [
      ...
      { property: "og:title", content: "Gradients for Tailwind CSS | Hypercolor" },
      {
      ...
      { property: "twitter:title", content: "Gradients for Tailwind CSS | Hypercolor" },
      {
